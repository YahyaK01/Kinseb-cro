...
const OutcomesSection = () => {
  ...
  const outcomes = [
  {
    ...
    description: "Delivered successful projects across diverse industries. Consistent execution drives results"
  },
  {
    number: "98%",
    targetNumber: 98,
    ...
    description: "Built strong client relationships through trust and performance. Results speak clearly"
  },
  {
    number: "45%",
    targetNumber: 45,
    ...
    description: "Optimized user journeys to increase returns efficiently. Data driven growth"
  },
  {
    number: "15+",
    targetNumber: 15,
    ...
    description: "Hands on experience delivering proven solutions. Expertise that drives success"
  }
];
