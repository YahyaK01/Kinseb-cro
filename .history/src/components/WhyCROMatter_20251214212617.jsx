    ...
    points: [
      {
        ...
        description: "We analyze real user data to identify what works and what doesn’t, allowing you to invest in strategies that deliver measurable returns and consistent growth."
      },
      {
        icon: "/images/2.png",
