...
const TrustedBrands = () => {
  ...
  const containerStyle = {
    ...
    alignItems: 'center',
    padding: windowWidth < 768 ? '30px 0' : '40px 0',
    width: '100%',
    minHeight: windowWidth < 768 ? 'auto' : '1800px',
    background: '#04091D',
    overflow: 'hidden',
  ...
  const cardStyle = {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    padding: windowWidth < 480 ? '10px 18px' : '12px 24px',
  ...
  const logoStyle = {
    width: windowWidth < 480 ? '70px' : windowWidth < 768 ? '90px' : '100px',
    height: 'auto',
    maxHeight: windowWidth < 480 ? '40px' : '50px',
    objectFit: 'contain',
    transition: 'transform 0.3s ease',
  };
